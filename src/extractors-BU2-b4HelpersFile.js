...
const constructApiUrl = (isViewAll, dataProductsUrl, productType) => {
    let apiUrl;
...
const getTotalNumOfProds = async (apiUrl, isViewAll, proxyUrls) => {
...
const getAllProductsByChunks = async (total, apiUrl, isViewAll, proxyUrls) => {
...
const getUtagData = ($) => {
    ...
    eval(dataString); // create utag_data
    const utagData = utag_data;

    return utagData;
}

const getAvailabilityList = async (groupCode) => {
